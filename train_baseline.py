...
from models.baseline import build_efficientnet_b0
...
CHECKPOINT_PATH = r"outputs\best_efficientnet_b0.pth"

SAVE_DIR = r"outputs\baseline_efficientnet_b0"
...
# Dataset wrapper
# =========================
# 기존 APTOSDataset은 image, label만 반환하므로
# 저장용으로 image_id, image_path까지 같이 반환하는 Dataset을 새로 정의
...
def save_classification_report(save_dir, labels, preds):
    ...
    print(f"Saved classification report: {save_path_json}")
    print(f"Saved classification report text: {save_path_txt}")
