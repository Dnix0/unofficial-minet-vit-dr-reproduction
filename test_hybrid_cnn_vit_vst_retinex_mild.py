...
CHECKPOINT_PATH = r"outputs\best_hybrid_cnn_vit_vst_retinex_mild.pth"

SAVE_DIR = r"outputs\hybrid_cnn_vit_vst_retinex_mild"
...
def save_metrics(save_dir, test_loss, test_metrics, checkpoint):
    metrics_to_save = {
        "model": "Hybrid CNN-ViT + Mild VST/Retinex",
...
def main():
    ...
    print("\nAll Hybrid CNN-ViT + Mild VST/Retinex results saved successfully.")
