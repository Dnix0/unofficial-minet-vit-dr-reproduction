...
def main():
    ...
    pretrained_checkpoint_path = r"outputs\best_denoised_hybrid_cnn_vit_alpha025.pth"
    ...
    print("Loaded pretrained alpha=0.25 checkpoint:", pretrained_checkpoint_path)
    ...
    optimizer = torch.optim.AdamW(
        [
            {"params": model.denoiser.parameters(), "lr": 1e-5},
    ...
    best_model_path = os.path.join(
        OUTPUT_DIR,
        "best_denoised_hybrid_cnn_vit_alpha025_finetune.pth"
    )
