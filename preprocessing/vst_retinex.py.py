...
def green_channel_guided_enhancement(arr, strength=0.15):
    """
    The paper mentions using the green channel because lesion/vessel contrast is clearer.
    This function lightly injects green channel contrast into RGB.
    """
    green = arr[:, :, 1:2]
...
def apply_vst_retinex(
    ...
    RGB image -> optional green-guided enhancement -> VST -> Retinex -> gamma correction.
    """
